 ...
 */
abstract contract LzAppUpgradeable is Initializable, ILayerZeroReceiver {
     ...
     */
    function _setConfig(uint16 version, uint16 chainId, uint256 configType, bytes calldata config) internal {
     ...
     */
    function _setSendVersion(uint16 version) internal {
     ...
     */
    function _setReceiveVersion(uint16 version) internal {
     ...
     */
    function _forceResumeReceive(uint16 srcChainId, bytes calldata srcAddress) internal {
     ...
     */
    function _setTrustedRemote(uint16 remoteChainId, bytes calldata path) internal {
        LzAppStorage storage $ = _getLzAppStorage();
     ...
     */
    function _setTrustedRemoteAddress(uint16 remoteChainId, bytes calldata remoteAddress) internal {
        LzAppStorage storage $ = _getLzAppStorage();
     ...
     */
    function _setMinDstGas(uint16 dstChainId, uint16 packetType, uint256 minGas) internal {
        LzAppStorage storage $ = _getLzAppStorage();
     ...
     */
    function _setPayloadSizeLimit(uint16 dstChainId, uint256 size) internal {
        LzAppStorage storage $ = _getLzAppStorage();
